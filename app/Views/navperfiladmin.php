        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="myNavbar">
                <ul class="navbar-nav float-left nav navbar-nav" style="font-size: 100%;">
                    <li class="nav-item ">
                        <a class="nav-link" href="<?php echo base_url();?>/index.php/Control/indexAdmin" style="color: #E8FBFA;">Inicio</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo base_url();?>/index.php/Control/CatalogoAdmin" style="color: #E8FBFA;">Catálogo</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo base_url();?>/index.php/Control/EstrenosAdmin" style="color: #E8FBFA; ">Estrenos</a>
                    </li>
                </ul>
                ...
                <ul class="nav navbar-nav navbar-right" style="margin-top: 7px; margin-right: 5px;">
                    ...
                    <div class="btn-group">
                        <button type="button" id="btnregistro" class="btn btn-default dropdown-toggle" data-toggle="dropdown" style="color: #E8FBFA;" >
                            Mi perfil<span class="caret"></span>
                        </button>
                        <ul class="dropdown-menu" role="menu">
                            <li><a href="<?php echo base_url();?>/index.php/Control/profileAdmin">Mi perfil</a></li>
                            <li class="divider"></li>
                            <li><a href="<?php echo base_url();?>/index.php/Control/consultaAdmin">Colsultar usuarios</a></li>
                            <li class="divider"></li>
                            <li><a href="<?php echo base_url();?>/index.php/Control/registroAdmin">Agregar nuevo administrador</a></li>
                            <li class="divider"></li>
