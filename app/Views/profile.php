                ...
                <div class="row">
                    <div id="profile">
                        ...
                        <div class="col-sm-6 col-md-8">
                            <h4>Bhaumik Patel</h4><h4> Bhaumik Patel</h4>
                            <p>
                            ...
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    <li><a href="<?php echo base_url();?>/index.php/Control/modificacionUsuario">Modificar datos</a></li>
                                    <li class="divider"></li>
                                    <li><a href="<?php echo base_url();?>/index.php/Control/pay">Agregar tarjeta</a></li>
                                    <li class="divider"></li>
