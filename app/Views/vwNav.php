        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="myNavbar">
                <ul class="navbar-nav float-left nav navbar-nav" style="font-size: 100%;">
                    <li class="nav-item ">
                        <a class="nav-link" href="<?php echo base_url();?>/index.php/Control/index" style="color: #E8FBFA;">Inicio</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo base_url();?>/index.php/Control/Catalogo" style="color: #E8FBFA;">Catálogo</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo base_url();?>/index.php/Control/Estrenos" style="color: #E8FBFA; ">Estrenos</a>
                    </li>
                </ul>
                ...
                <ul class="nav navbar-nav navbar-right" style="margin-top: 7px; margin-right: 5px;">
                    <button id="btningresar" type="submit" class="btn">
                        <a href="<?php echo base_url();?>/index.php/Control/sesion">ingresar</a>
                    </button>
                    <button id="btnregistro" type="submit" class="btn">
                        <a href="<?php echo base_url();?>/index.php/Control/registro" style="color: #E8FBFA;" >registrar</a>
                    </button>
                </ul>
